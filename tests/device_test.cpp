...
// Forward declaration for functions in Teapot namespace that are not in headers
namespace Teapot {
    void err(const std::string& message);
}

// Mock implementation for err to avoid linking errors and to be able to catch errors in tests
void Teapot::err(const std::string& message) {
